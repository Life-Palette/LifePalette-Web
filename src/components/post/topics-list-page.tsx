...
/* biome-ignore-all lint/performance/noJsxPropsBind: topic actions intentionally capture page state */
...
import { useInfiniteTopics } from "@/hooks/use-topics";
    ...
    <PageLayout activeTab={activeTab}>
        ...
        <SimpleImageDetail
          ...
          onEdit={async (topicId) => {
            try {
              ...
              console.error("加载话题失败:", loadError);
            }
          }}
          originRect={cardRect}
      ...
      {!!editingTopicId && !!editingTopicData && (
        <CreatePostModal
          ...
          onSubmit={async (postData: Record<string, unknown>) => {
            try {
