...
const emits = defineEmits(['confirm']) // import { commonApi } from '../../api' // 封装的api
...
/* 上传图片前置拦截函数 */
function beforeUploadEvent(file: File) {
...
/* 上传成功方法 */
async function cropperSuccess(dataFile: File) {
...
// 裁剪之后的数据
function previewHandle(data: any) {
          ...
          <div class="reupload_box">
            ...
            <div flex gap-2>
              ...
              <div
                ...
                @click="changeScale(-1)"
              />
              <div i-carbon-reset icon-btn @click="rotateRight" />
            </div>
          </div>
        </div>
