...
/* biome-ignore-all lint/performance/noJsxPropsBind: photo wall callbacks intentionally capture selection state */
...
import PhotoWallUploader from "./photo-wall-uploader";
    ...
    return (
      <>
        <LottieAnimation
          ...
          emptyDescription={
            isOwnProfile ? "上传的照片将会在这里展示" : "TA还没有上传照片"
          }
                        ...
                        <div className="absolute top-1 right-1 opacity-0 transition-opacity group-hover:opacity-100">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem
                                onClick={(e) => handleCopyUrl(photo, e)}
                              >
            ...
            <AlertDialogDescription>
              {deleteTarget?.hasTopic ? (
                <span className="text-destructive">
                  ⚠️
                  此照片已被文章引用，删除后相关文章中的图片将无法显示。确定要删除吗？
                </span>
              ) : (
                "确定要删除这张照片吗？此操作无法撤销。"
              )}
