...
/* biome-ignore-all lint/style/useDestructuring: this existing integration requires the current implementation */
/* biome-ignore-all lint/style/noNestedTernary: this existing integration requires the current implementation */
/* biome-ignore-all lint/performance/noJsxPropsBind: profile form callbacks intentionally capture field state */
...
import BackgroundUpload from "@/components/media/background-upload";
...
import { useSendEmailCode } from "@/hooks/use-auth";
      ...
      >
        {([canSubmit, isSubmitting, isDirty]) => (
          <Button
            ...
            disabled={
              !canSubmit ||
              (!isDirty && avatarFile === null && backgroundFile === null)
            }
