...
export default function ColorDetailPanel({
            ...
            return (
              ...
              >
                {rowFiles.map((file, idx) => {
                  ...
                  return (
                    <button
                      className="group relative aspect-square cursor-pointer overflow-hidden rounded-lg border-0 bg-muted p-0 text-left"
  ...
  return (
    <>
      <Dialog onOpenChange={handleDialogOpenChange} open={!!color}>
        <DialogContent className="flex max-h-[90vh] max-w-2xl flex-col gap-0 overflow-hidden p-0">
          ...
          >
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span
                className={cn(
                  "font-bold font-mono text-3xl tracking-wider",
                  textColor
                )}
              >
              ...
              {!!rgb && (
                <span
                  className={cn("mt-2 font-mono text-sm opacity-80", textColor)}
                >
