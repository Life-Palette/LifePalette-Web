...
function ChatRoomItem({
  ...
  >[number];
  virtualizer: ReturnType<typeof useVirtualizer<HTMLDivElement>>;
}) {
  ...
  return (
    ...
    >
      <button
        className={`mx-2 my-1 flex w-[calc(100%-1rem)] cursor-pointer items-start gap-3 rounded-xl border-0 px-4 py-3 text-left transition-all ${isActive ? "bg-neutral-100 shadow-sm dark:bg-neutral-800" : "hover:bg-neutral-50 dark:hover:bg-neutral-800/30"}`}
  ...
  return (
    <div className="flex h-full flex-col bg-white dark:bg-neutral-900">
      ...
      <div className="flex items-center justify-between border-neutral-100 border-b px-5 py-4 dark:border-neutral-800">
        <h2 className="font-bold text-neutral-900 text-xl dark:text-white">
          消息
        </h2>
      </div>
