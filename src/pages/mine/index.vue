...
const { files, open, reset, onChange } = useFileDialog({    //更换头像
  accept: "image/*",
});
...
<template>
  <div class="h-full w-full flex flex-col bg-col">
    <!-- 头部 -->
    <div class="content">
      <div class="top" >
    ...
    <div class="information">
      ...
      <div class="piece">
        <div class="piece-item"></div>
        <div class="piece-items">个性签名</div>
      </div>
      <div class="My-me">
        <div class="room">
          <div class="My-room">
