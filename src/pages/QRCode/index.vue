<template>
  <div class="login-content_code flex-col flex justify-center items-center">
    ...
    <div class="qr-code-area relative h-[300px] w-[300px]">
      ...
      <template v-else-if="qrCodeStatus === 'timeout'">
        <div
          @click="handle_refreshLoginQrCode"
          class="w-full cursor-pointer h-full absolute top-0 left-0 flex items-center justify-center"
        >
          <!-- 遮罩层 -->
          <div
          ...
          ></div>
          <!-- 刷新 -->
          <div class="absolute bottom-10 color-white w-full z-99">
            点击刷新二维码
          </div>
        </div>
      </template>
